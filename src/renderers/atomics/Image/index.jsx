...
export default class Image extends React.Component {
  ...
  render() {
    ...
    let { url, link, link_target, width, height, meta, tipText } = mediaData;
    let imageStyles = {};
    let clearFix = false;
    ...
    return (
      <div className="bf-media">
        ...
        >
          {toolbarVisible ? (
            <div
              style={{ marginLeft: toolbarOffset, bottom: "30px" }}
              ...
              {tipEditorVisible ? (
                <div className="bf-image-link-editor">
                  <div className="editor-input-group">
                    ...
                    />
                    <button type="button" onClick={this.confirmtipText}>
                      {language.base.confirm}
                    </button>
                  </div>
                </div>
  ...
  toggleTipEditor= () =>{
    this.setState({
      tipEditorVisible: !this.state.tipEditorVisible,
    });
  }
